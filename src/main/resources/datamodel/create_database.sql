...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA dcsa_v1_1 TO dcsa_db_owner;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA dcsa_v2_0 TO dcsa_db_owner;
